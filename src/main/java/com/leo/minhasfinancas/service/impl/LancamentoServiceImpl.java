...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public List<Lancamento> buscar(Lancamento lancamentoFiltro) {
		...
		//o objeto example considera apenas as propriedades populadas
		//da entidade de filtro para montar a query de consulta
		Example example = Example.of(lancamentoFiltro, ExampleMatcher.matching()
				.withIgnoreCase()//ignora a caixa alta ou baixa da string
				.withStringMatcher(StringMatcher.CONTAINING)//faz o like
				);
